...
Write-host "Sending out e-mail..."
 ...
 Send-MailMessage -From 'vm-cm-01@acme.com' -To 'patches@acme.com' -Subject 'Server Pilot Patching' -Body "The following servers will be
...
$serverplus4br += "$_ <br>"
 ...
 Send-MailMessage -From 'vm-cm-01@acme.com' -To 'patches@acme.com' -Subject 'Server Weekend Patching +4 days after Patch Tuesday' -Body "The following servers will be
...
$serverplus11br += "$_ <br>"
 ...
 Send-MailMessage -From 'vm-cm-01@acme.com' -To 'patches@acme.com' -Subject 'Server Weekend Patching +11 days after Patch Tuesday' -Body "The following servers will be
...
Send-MailMessage -From 'vm-cm-01@acme.com' -To 'patches@acme.com' -Subject 'Server Weekend Patching +18 days after Patch Tuesday' -Body "The following servers will be
